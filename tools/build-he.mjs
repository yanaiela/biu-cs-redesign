...
script = rep(script, [
  [`const AREAS=[
  {k:'Theory',n:'Algorithms & Theory',i:'i-graph',d:'Pattern matching, dynamic and graph algorithms, geometry, complexity.',lab:'theory'},
  {k:'AI',n:'Artificial Intelligence',i:'i-spark',d:'Multi-agent systems, planning, negotiation and human–agent interaction.',lab:'ai'},
  {k:'ML',n:'Machine Learning',i:'i-chart',d:'Deep learning theory, representation learning, few-shot generalization.',lab:'ml'},
  {k:'NLP',n:'Natural Language Processing',i:'i-chat',d:'Language models, interpretability, Hebrew and morphologically rich languages.',lab:'nlp'},
  {k:'Robotics',n:'Robotics',i:'i-robot',d:'Multi-robot systems, swarms, and assistive robots such as a robotic guide dog.',lab:'robotics'},
  {k:'Crypto',n:'Cryptography & Cyber Security',i:'i-lock',d:'Secure computation, protocols, privacy.',lab:'crypto'},
  {k:'Verification',n:'Formal Methods & Verification',i:'i-book',d:'Verification of hardware and software, automated reasoning, SMT.',lab:'formal-methods'},
  {k:'Data',n:'Data & Information Retrieval',i:'i-layers',d:'Data management in the cloud, crowdsourcing, information retrieval.',lab:'data'},
  {k:'Bioinformatics',n:'Bioinformatics',i:'i-ai',d:'Biological sequences, mathematical biology, genomic big data.',lab:'bioinformatics'},
];`,
   `const AREAS=[
  {k:'Theory',n:'אלגוריתמים ותאוריה',i:'i-graph',d:'התאמת תבניות, אלגוריתמים דינמיים ואלגוריתמים לגרפים, גאומטריה, סיבוכיות.',lab:'theory'},
  {k:'AI',n:'בינה מלאכותית',i:'i-spark',d:'מערכות מרובות סוכנים, תכנון, משא ומתן ואינטראקציה בין אדם לסוכן.',lab:'ai'},
  {k:'ML',n:'למידת מכונה',i:'i-chart',d:'תאוריה של למידה עמוקה, למידת ייצוגים, הכללה מדוגמאות מעטות.',lab:'ml'},
  {k:'NLP',n:'עיבוד שפה טבעית',i:'i-chat',d:'מודלי שפה, פרשנות מודלים, עברית ושפות עשירות מורפולוגית.',lab:'nlp'},
  {k:'Robotics',n:'רובוטיקה',i:'i-robot',d:'מערכות מרובות רובוטים, נחילים ורובוטים מסייעים, כמו כלב נחייה רובוטי.',lab:'robotics'},
  {k:'Crypto',n:'קריפטוגרפיה וסייבר',i:'i-lock',d:'חישוב מאובטח, פרוטוקולים, פרטיות.',lab:'crypto'},
  {k:'Verification',n:'שיטות פורמליות ואימות',i:'i-book',d:'אימות חומרה ותוכנה, הסקה אוטומטית, SMT.',lab:'formal-methods'},
  {k:'Data',n:'נתונים ואחזור מידע',i:'i-layers',d:'ניהול נתונים בענן, מיקור המונים ואחזור מידע.',lab:'data'},
  {k:'Bioinformatics',n:'ביואינפורמטיקה',i:'i-ai',d:'רצפים ביולוגיים, ביולוגיה מתמטית, ביג דאטה גנומי.',lab:'bioinformatics'},
];`],
  ['} faculty members${more}', '} חברי סגל${more}'],
  ['>More on labs &amp; groups</a>', '>עוד במעבדות וקבוצות</a>'],
